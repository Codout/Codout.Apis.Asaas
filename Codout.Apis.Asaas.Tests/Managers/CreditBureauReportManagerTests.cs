...
public class CreditBureauReportManagerTests : ManagerTestBase<CreditBureauReportManager>
{
    ...
    {
        SetupOkResponse("{\"id\":\"cbr_123\",\"customer\":\"cus_abc\",\"cpfCnpj\":\"12345678901\",\"dateCreated\":\"2024-01-15\",\"downloadUrl\":\"https://example/cbr.pdf\",\"reportFile\":\"JVBERi0xLjQK\"}");
        ...
        Assert.Equal("https://example/cbr.pdf", result.Data.DownloadUrl);
        Assert.Equal("JVBERi0xLjQK", result.Data.ReportFile);
    }
    ...
    {
        SetupListResponse<CreditBureauReport>("[{\"id\":\"cbr_1\",\"customer\":\"cus_abc\",\"cpfCnpj\":\"12345678901\",\"dateCreated\":\"2024-01-15\"}]", totalCount: 1, limit: 10, offset: 0);
    ...
    {
        SetupOkResponse("{\"id\":\"cbr_456\",\"customer\":\"cus_def\",\"cpfCnpj\":\"11122233344\",\"dateCreated\":\"2024-02-20\"}");
